...
namespace Gameplay
{
    public static class GameplayHelper
    {
        ...
        public static decimal CalculateStarsReviewForOrder(List<PizzaIngredient> missingIngredients, List<PizzaIngredient> unwantedIngredients, Pizza.BakingStageEnum stage)
        {
            decimal review = 5;
